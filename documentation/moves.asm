...
; entries correspond to constants/move_constants.asm
	move POUND,        EFFECT_NORMAL_HIT,         35, NORMAL, PHYSICAL,       100, 35,   0
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         55, FIGHTING, PHYSICAL,     100, 20,   0
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          15, NORMAL, PHYSICAL,        90, 15,   0
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          20, FIGHTING, PHYSICAL,        85, 15,   0
	move BRAINFREEZE,  EFFECT_SP_ATK_DOWN_HIT,    60, ICE, SPECIAL,        95, 5,   100
	move PAY_DAY,      EFFECT_PAY_DAY,            40, NORMAL, PHYSICAL,       100, 20,   0
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           80, FIRE, PHYSICAL,         100, 15,  10
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         80, ICE, PHYSICAL,          100, 15,  10
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       80, ELECTRIC, PHYSICAL,     100, 15,  10
	move SCRATCH,      EFFECT_NORMAL_HIT,         35, NORMAL, PHYSICAL,      95, 35,   0
	move VICEGRIP,     EFFECT_TRAP_TARGET,         25, NORMAL, PHYSICAL,       100, 20,   0
	move GUILLOTINE,   EFFECT_OHKO,                0, NORMAL, PHYSICAL,       30,  5,   0
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,        150, NORMAL, PHYSICAL,       95, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL, STATUS,      100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         60, NORMAL, PHYSICAL,       95, 30,   0
	...
	move EARTHPOWER,   EFFECT_SP_ATK_UP_HIT,      80, GROUND, SPECIAL,       100, 15,   10
	move SLAM,         EFFECT_NORMAL_HIT,         85, NORMAL, PHYSICAL,       90, 20,   0
	move HELLFIRE,     EFFECT_NORMAL_HIT,         100, DARK,   SPECIAL,     100, 10,   0
	move STOMP,        EFFECT_STOMP,              70, NORMAL, PHYSICAL,      100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING, PHYSICAL,    100, 30,   0
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL, PHYSICAL,        85,  5,   0
	move JUMP_KICK,    EFFECT_JUMP_KICK,          90, FIGHTING, PHYSICAL,     95, 25,   0
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         70, FIGHTING, PHYSICAL,     95, 15,  30
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, ROCK, STATUS,      100, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         65, NORMAL, PHYSICAL,      100, 15,  30
	move HORN_ATTACK,  EFFECT_NORMAL_HIT,         75, NORMAL, PHYSICAL,      100, 25,   0
	move FURY_ATTACK,  EFFECT_MULTI_HIT,          15, NORMAL, PHYSICAL,       90, 20,   0
	move HORN_DRILL,   EFFECT_OHKO,                1, NORMAL, PHYSICAL,       30,  5,   0
	move TACKLE,       EFFECT_NORMAL_HIT,         35, NORMAL, PHYSICAL,       95, 35,   0
	move BODY_SLAM,    EFFECT_PARALYZE_HIT,       80, NORMAL, PHYSICAL,      100, 15,  30
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL, PHYSICAL,       85, 20,   0
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         95, NORMAL, PHYSICAL,       85, 20,   0
	move THRASH,       EFFECT_RAMPAGE,            100, NORMAL, PHYSICAL,      95, 20,   0
	...
	move POISON_STING, EFFECT_POISON_HIT,         25, POISON, PHYSICAL,      95, 35,  35
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   40, BUG,    PHYSICAL,      100, 20,  20
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          19, BUG,    PHYSICAL,       85, 20,   0
	move LEER,         EFFECT_DEFENSE_DOWN,        0, NORMAL, STATUS,      100, 30,   0
	move BITE,         EFFECT_FLINCH_HIT,         60, NORMAL, PHYSICAL,        100, 25,  30
	...
	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, NORMAL, SPECIAL,       100, 20,   0
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL, STATUS,       90, 20,   0
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   40, POISON, SPECIAL,      100, 25,  50
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,   SPECIAL,      100, 25,  15
	...
	move SURF,         EFFECT_NORMAL_HIT,         85, WATER,  SPECIAL,      100, 15,   0
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         90, ICE,    SPECIAL,      100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,    SPECIAL,       70,  5,  15
	...
	move AURORA_BEAM,  EFFECT_ACCURACY_DOWN_HIT,    65, ICE, SPECIAL,         100, 20,  20
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        175, CURSE_TYPE, SPECIAL,        90,  5,   0
	move PECK,         EFFECT_NORMAL_HIT,         35, FLYING, PHYSICAL,      100, 35,   100
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         80, NORMAL,   PHYSICAL,    95, 15,   0
	move ABSORB,       EFFECT_LEECH_HIT,          30, GRASS,    SPECIAL,    100, 20,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          55, GRASS,    SPECIAL,    100, 10,   0
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, GRASS,    STATUS,     90, 15,   0
	move GROWTH,       EFFECT_GROWTH,              0, GRASS,    STATUS,   100, 40,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        55, FIRE,     SPECIAL,     90, 15,   0
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         60, ROCK,     PHYSICAL,     90, 15,   0
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,        100, GROUND,   PHYSICAL,    100, 10,   0
	move HYPER_VOICE,  EFFECT_NORMAL_HIT,         85, NORMAL, SPECIAL,       100,  15,   0
	move DIG,          EFFECT_FLY,                75, GROUND, PHYSICAL,      100, 15,   0
	move TOXIC,        EFFECT_TOXIC,               0, POISON, STATUS,       85, 10,   0
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC_TYPE, SPECIAL, 100, 20,  20
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC_TYPE, SPECIAL, 100, 10,  10
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC_TYPE, STATUS,  65, 15,   0
	move MEDITATE,     EFFECT_MEDITATE,           0, PSYCHIC_TYPE, STATUS, 100, 15,   0
	...
	move ICICLESTRIKE, EFFECT_NORMAL_HIT,               90, ICE, PHYSICAL,      90, 15,   0
	...
	move FOCUS_ENERGY, EFFECT_ATTACK_UP,           0, NORMAL, STATUS,      100, 30,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL, PHYSICAL,       85, 10,   0
	move LICK,         EFFECT_PARALYZE_HIT,       20, NORMAL, PHYSICAL,       100, 30,  30
	move POISON_FANG,  EFFECT_POISON_HIT,         60, POISON, PHYSICAL,       95, 20,  40
	move SLUDGE,       EFFECT_POISON_HIT,         65, POISON, PHYSICAL,      100, 20,  15
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND, PHYSICAL,       90, 20,  20
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,   SPECIAL,       80,  5,  20
	...
	move STAR_SHIELD,   EFFECT_STAR_SHIELD,        0, BUG, STATUS,      100, 10,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, NORMAL, PHYSICAL,      100, 15,   0
	move FLARE_BLITZ,  EFFECT_RECOIL_HIT,     120, FIRE,  PHYSICAL,     85, 10,  0
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC_TYPE, STATUS, 100, 20,   0
	move METALSCREECH, EFFECT_SP_DEF_DOWN_HIT,       75, STEEL, SPECIAL,  100, 15,   30
	move SOFTBOILED,   EFFECT_HEAL,                0, NORMAL, STATUS,      100, 10,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          120, FIGHTING, PHYSICAL,     90, 10,   0
	move GLARE,        EFFECT_PARALYZE,            0, DARK,  STATUS,      85, 30,   0
	move DREAM_EATER,  EFFECT_DREAM_EATER,       100, PSYCHIC_TYPE, SPECIAL, 100, 15,   0
	move BUG_CLAW,   EFFECT_NORMAL_HIT,              80, BUG,  PHYSICAL,      100, 15, 0
	move COCONUT_GUN,  EFFECT_DOUBLE_HIT,          55, GRASS,  PHYSICAL,      90, 10,   0
	...
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,  PHYSICAL,     100, 10,  40
	move SPORE,        EFFECT_SLEEP,               0, GRASS,   STATUS,     100, 15,   0
	move FLASH,        EFFECT_ACCURACY_DOWN,       0, NORMAL,  STATUS,      90, 20,   0
	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC_TYPE, SPECIAL, 85, 15,   0
	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,  STATUS,     100, 5,   0
	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,  STATUS,     100, 40,   0
	move CRABHAMMER,   EFFECT_FLINCH_HIT,         95, WATER,   PHYSICAL,      95, 10,   10
	move EXPLOSION,    EFFECT_SELFDESTRUCT,      250, NORMAL,  PHYSICAL,     100,  5,   0
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL,  PHYSICAL,      85, 25,   0
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         55, GROUND,  PHYSICAL,      90, 10,   0
	...
	move SHARPEN,      EFFECT_ATTACK_UP_2,           0, NORMAL, STATUS,      100, 30,   0
	...
	move THIEF,        EFFECT_THIEF,              66, DARK, PHYSICAL,        100, 10, 100
	move SPIDER_WEB,   EFFECT_SPIDER_WEB,           0, BUG,  STATUS,        100, 10,   0
	move ACID_JET,  EFFECT_DEFENSE_DOWN_HIT,             90, POISON, SPECIAL,      90,  10,   20
	move NIGHTMARE,    EFFECT_NIGHTMARE,           0, GHOST, STATUS,       100, 15,   0
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,  PHYSICAL,       100, 25,  10
	move SNORE,        EFFECT_SNORE,             100, NORMAL, SPECIAL,      100, 15,  35
	...
	move COTTON_SPORE, EFFECT_SPEED_DOWN_2,        0, GRASS,  STATUS,       90, 40,   0
	move REVERSAL,     EFFECT_REVERSAL,            1, FIGHTING, PHYSICAL,    100, 15,   0
	move SPITE,        EFFECT_SPITE,               0, GHOST,  STATUS,      100, 10,   0
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         35, ICE,  SPECIAL,       100, 25,  15
	move PROTECT,      EFFECT_PROTECT,             0, NORMAL, STATUS,      100, 5,   0
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON, PHYSICAL,      95, 10,  30
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND, SPECIAL,      100, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  80, WATER,  SPECIAL,       85, 10,  50
	...
	move CACKLE,       EFFECT_ATTACK_DOWN_HIT,    50, DARK, SPECIAL,        100, 10, 100
	move SANDBLAST,    EFFECT_FLINCH_HIT,         75, ROCK, SPECIAL,        95, 15,   30
	move LOCK_ON,      EFFECT_LOCK_ON,             0, NORMAL, STATUS,      100,  10,   0
	move OUTRAGE,      EFFECT_RAMPAGE,           120, DRAGON, PHYSICAL,      90, 10,   0
	...
	move ROLLOUT,      EFFECT_ROLLOUT,            40, NORMAL, PHYSICAL,         90, 20,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     75, STEEL, PHYSICAL,        90, 25,  10
	...
	move PAIN_SPLIT,   EFFECT_PAIN_SPLIT,          0, GHOST, STATUS,      100, 20,   0
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,  SPECIAL,        95,  5,  50
	move MAGNITUDE,    EFFECT_MAGNITUDE,           1, GROUND,  PHYSICAL,     100, 30,   0
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       120, FIGHTING, PHYSICAL,     50,  5, 100
	move MEGAHORN,     EFFECT_NORMAL_HIT,        110, BUG, PHYSICAL,          90, 10,   0
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       90, DRAGON, SPECIAL,      100, 10,  20
	...
	move RAPID_SPIN,   EFFECT_RAPID_SPIN,         50, NORMAL, PHYSICAL,      100, 40,   50
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      75, STEEL,  PHYSICAL,       95, 15,  15
	move VITAL_THROW,  EFFECT_ALWAYS_HIT,         80, FIGHTING, PHYSICAL,    100, 10,   0
	...
	move TWISTER,      EFFECT_TWISTER,            90, FLYING, SPECIAL,      100, 10,  15
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,  STATUS,       90,  5,   0
	move SUNNY_DAY,    EFFECT_SUNNY_DAY,           0, FIRE,   STATUS,       90,  5,   0
	move CRUNCH,       EFFECT_DEFENSE_DOWN_HIT,   85, DARK,   PHYSICAL,      100, 15,  20
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         65, ROCK,   SPECIAL,      100,  10,  10
	move SHADOW_BALL,  EFFECT_SHADOW_BALL,    40, GHOST,  SPECIAL,      100, 15,  20
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,       100, PSYCHIC_TYPE, SPECIAL,  100, 15,   0
	...
	move BEAT_UP,      EFFECT_BEAT_UP,            18, DARK,  PHYSICAL,       100, 10,   0
	move SILVER_WIND,  EFFECT_ALL_UP_HIT,         65, BUG,   SPECIAL,       100, 10,  15
	move BUG_BUZZ,     EFFECT_NORMAL_HIT,         85, BUG,   SPECIAL,       100, 15,   0
